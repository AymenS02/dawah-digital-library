    ...
    <div className="">
      <section className="relative bg-[url('/homepage/hero.jpeg')] bg-cover bg-center w-full h-[60vh] min-h-[500px] flex flex-col px-4">
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            ...
            <h2 className="absolute pt-12 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[4rem] md:text-[8rem] lg:text-[12rem] font-bold text-white/10 whitespace-nowrap pointer-events-none select-none">
              WELCOME
            </h2>
            
            <h1 className="text-white text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-center font-light tracking-wider">
      ...
      <section className="relative flex flex-col mx-auto max-w-7xl mt-10 md:mt-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-4 text-foreground text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 py-10 mt-20">
            ...
            <div className="flex flex-col items-center w-full gap-4">
              ...
              <h3 className="text-xl sm:text-2xl text-foreground">Non-Muslims</h3>
            </div>

            <div className="flex flex-col items-center w-full gap-4">
              <MapPin onClick={() => window.location.href = '/revert'} className="cursor-pointer w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 text-primary transition-transform hover:scale-150 duration-500 hover:-translate-y-10" />
              <hr className="border-foreground mb-2 border-2 w-full" />
              <h3 className="text-xl sm:text-2xl text-foreground">New Reverts</h3>
            </div>
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-foreground text-center mt-8">
            UNSURE?
          </h1>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-0 mt-8 mb-12">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-foreground text-center lg:text-left lg:w-1/2">
              USER INTAKE QUIZ
            </h1>

            <div className="bg-foreground w-full lg:w-1/2 h-auto p-6 sm:p-8 md:p-10 rounded-lg lg:rounded-none">
              ...
              <button className="mt-4 bg-background mx-auto text-foreground px-4 py-2 rounded-lg hover:scale-105 transition-transform duration-300 block">
                Start Here
              </button>
            </div>
          </div>
