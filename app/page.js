...
export default function Home() {
  return (
    <div className="">
      <section className="relative bg-[url('/homepage/hero.jpeg')] bg-cover bg-center w-full h-[75vh] min-h-[500px] flex flex-col px-4">
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            ...
            <h1 className="font-zcool text-[#d1c1af] text-4xl sm:text-5xl md:text-6xl lg:text-9xl text-center font-light tracking-wider">
      ...
      <section className="relative flex flex-col mx-auto max-w-7xl mt-10 md:mt-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10">
          <h2 className="font-ovo text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-4 text-foreground text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 py-10 mt-20">
            ...
            <div className="flex flex-col items-center w-full gap-4">
              <MapPin
                onClick={() => (window.location.href = "/non-muslim")}
                className="cursor-pointer w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 transition-transform hover:scale-150 duration-500 hover:-translate-y-10"
                stroke="url(#pinGradient)"
              >
                <defs>
                  <linearGradient id="pinGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#ffffff" />
                    <stop offset="50%" stopColor="#bdac98" />
              ...
              <h3 className="text-xl sm:text-2xl text-foreground font-ovo">Non-Muslims</h3>
            </div>
            ...
            <div className="flex flex-col items-center w-full gap-4">
              ...
              <h3 className="text-xl sm:text-2xl text-foreground font-ovo">
                New Reverts
              </h3>
            </div>
            ...
            <div className="flex flex-col items-center w-full gap-4">
              <MapPin 
                onClick={() => window.location.href = '/muslim'} 
                className="cursor-pointer w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 transition-transform hover:scale-150 duration-500 hover:-translate-y-10"
                stroke="url(#pinGradient)"
              >
                <defs>
              ...
              </MapPin>              {/* HR with center circle */}
              <div className="relative w-full flex items-center">
                <hr className="w-full border-foreground border-2" />
                <span className="absolute left-1/2 -translate-x-1/2 bg-background border-2 border-foreground rounded-full w-4 h-4" />
              </div>
              <h3 className="text-xl sm:text-2xl text-foreground font-ovo">Muslims</h3>
            </div>

          </div>

          <h1 className="font-ovo text-lg sm:text-2xl md:text-3xl lg:text-4xl text-foreground text-center mt-8">
            UNSURE?
          </h1>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-0 mt-8 mb-12">
            <h1 className="font-ovo text-lg sm:text-xl md:text-2xl lg:text-4xl text-foreground text-center lg:text-right mr-20 lg:w-1/2">
              USER INTAKE QUIZ
            </h1>

            <div className="bg-foreground w-full lg:w-1/2 h-auto p-4 sm:p-6 md:p-8 rounded-2xl">
              <p className="text-background text-lg text-center font-ovo font-bold">
                Find out your knowledge level, goals, and preferred learning style to be directed to the most effective resources for you!
              </p>
              <button className="font-ovo mt-4 bg-background mx-auto text-foreground px-4 py-2 rounded-lg hover:scale-105 transition-transform duration-300 block" onClick={() => window.location.href = '/quiz'}>
                START HERE
              </button>
            </div>
          </div>
